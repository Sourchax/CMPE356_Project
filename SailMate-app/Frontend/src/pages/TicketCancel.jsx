    ...
    <div className="flex flex-col min-h-screen relative overflow-hidden bg-white">
      ...
      <div className="relative z-10 mt-[20vh] px-4 flex flex-col items-center flex-grow">
        <div className="text-center text-white mb-5 animate-[fadeIn_0.8s_ease-out]">
          <h1 className="text-4xl font-bold mb-1">Cancel Your Ticket</h1>
          <p className="text-base opacity-90 max-w-[600px] mx-auto">We're sorry you need to cancel. Please enter your ticket details below.</p>
        </div>

        <div className="bg-white rounded-lg shadow-lg w-full max-w-[550px] p-6 mb-8 animate-[fadeIn_1s_ease-out]">
          {!showConfirmation ? (
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <textarea 
                    ...
                    rows="3"
                    className="pl-10 w-full py-2 border border-gray-300 rounded-md shadow-sm focus:ring-[#06AED5] focus:border-[#06AED5] focus:outline-none resize-none"
                  ></textarea>
                </div>
              </div>
            ...
            <div className="animate-[fadeIn_0.5s_ease-out]">
              ...
              <div className="py-4">
                <p className="text-center text-gray-600 mb-4">Are you sure you want to cancel your ticket?</p>
                <div className="bg-gray-50 rounded-md p-4 space-y-2 mb-4">
                  <div className="flex justify-between">
                    <span className="text-gray-600">Ticket ID:</span>
                    <span className="font-medium text-gray-700">{ticketId}</span>
                  </div>
                  <div className="flex justify-between">
                ...
                <p className="text-red-600 text-sm italic">This action cannot be undone. Refund policies will apply according to your ticket terms.</p>
              </div>
              ...
              <div className="flex gap-4 mt-6">
                ...
                <button 
                  ...
                  className={`flex-1 bg-[#0D3A73] hover:bg-[#06AED5] text-white py-3 px-6 rounded-lg shadow-md hover:shadow-lg font-medium transition-all duration-300 ${loading ? 'relative' : ''}`}
                  disabled={loading}
                >
                  {loading ? (
                    <div className="absolute inset-0 flex items-center justify-center">
